...
import { Server, ChevronRight, Bot, Wheat, Heart, Sparkles, Droplets, Sprout, ArrowUpRight } from 'lucide-react';
...
export default function ServerSelectionTab({ servers, onSelectServer, onTriggerToast }: ServerSelectionTabProps) {
  ...
  return (
    <div className="w-full space-y-8">
      {/* SEÇÃO DE SELEÇÃO DE SERVIDORES */}
      <div>
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-extrabold text-white tracking-tight font-display">Seus Servidores</h2>
            <p className="text-zinc-400 mt-1 text-xs">Selecione um servidor abaixo para acessar o painel de controle e configurações.</p>
          </div>
          <span className="text-xs font-mono text-zinc-500 bg-zinc-900 border border-zinc-800 px-3 py-1 rounded-xl">
